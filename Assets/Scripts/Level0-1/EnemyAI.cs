...
{    
    ...
    void Start()
    {
        playerASpeed = GameObject.Find("Player").GetComponent<PlayerController>().fireDelay;
    ...
    IEnumerator DeathDelay()
    {
        ...
        // increasing Attack Speed when killing enemy
        playerASpeed = GameObject.Find("Player").GetComponent<PlayerController>().fireDelay;
        playerASpeed = playerASpeed * 0.9f;
        GameObject.Find("Player").GetComponent<PlayerController>().fireDelay = playerASpeed;

        //increasing attack damage when killing enemy
        playerDamage = GameObject.Find("Player").GetComponent<PlayerController>().damage;
        playerDamage = playerDamage + (playerDamage * 0.5f);
        GameObject.Find("Player").GetComponent<PlayerController>().damage = playerDamage;
